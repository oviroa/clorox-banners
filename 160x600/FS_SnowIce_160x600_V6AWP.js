...
(lib.txt_thebestforyourcat = function() {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4787AD").s().p("");
	this.shape.setTransform(89.1,-15.6);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-67.9,-35.4,314,91.2);
...
(lib.txt_dontspinyourwheels = function() {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4787AD").s().p("");
	this.shape.setTransform(123.2,40.5);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,5.6,247.1,87.4);
...
(lib.txt_3 = function() {
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#565A5C").s().p("");
	this.shape.setTransform(137.6,50.3);

	// Layer 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#4686AD").s().p("");
	this.shape_1.setTransform(91.3,24);
	...
	this.shape_2.setTransform(91.9,78.5);

	this.addChild(this.shape_2,this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-4,0,191.1,134.5);
...
(lib.snowblue = function() {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#B7D9F0").s().p("");
	this.shape_2.setTransform(408,227.1);

	this.addChild(this.shape_2,this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-4.9,0,982.8,438.4);
...
(lib.road = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#939CA3").s().p("A91UkMAAAgpHMA7qAAAMAAAApHg");
	this.shape.setTransform(191,131.6);

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,382,263.3);
...
(lib.snowdriftALL = function() {
	...
	this.instance.setTransform(-302.9,130.3,0.525,0.994,0,0,0,685.7,114.2);

	this.instance_1 = new lib.snowdrifts();
	this.instance_1.setTransform(360.3,130.3,0.525,0.994,0,0,0,685.7,114.2);

	this.addChild(this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-663.2,16.8,1383.6,226.7);
...
(lib.snow = function() {
	...
	this.instance.setTransform(-484.1,217.2,0.932,1.643,0,0,180,486.5,105.4);

	this.instance_1 = new lib.snowblue();
	this.instance_1.setTransform(187.7,217.2,0.932,1.643,0,0,180,486.5,105.4);

	// Layer 1
	this.instance_2 = new lib.snowwhite();
	this.instance_2.setTransform(-264.5,184.3,1.019,1.675,0,0,0,488.9,93.8);

	this.instance_3 = new lib.snowwhite();
	this.instance_3.setTransform(456.7,184.3,1.019,1.675,0,0,0,488.9,93.8);

	this.addChild(this.instance_3,this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-795.7,53.5,1590.9,710.9);
...
p.nominalBounds = new cjs.Rectangle(-1333.6,0,2352.6,263.3);
...
(lib.CAMERAanim = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(76.1,323.9,1.344,1.344,0,0,0,459.6,109.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(180).to({x:555},20,cjs.Ease.get(-1)).to({x:1034.7},28,cjs.Ease.get(1)).wait(17).to({regY:109.4,scaleX:1.51,scaleY:1.51,x:1156.3,y:372.2},11).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(24).to({rotation:-1080},25,cjs.Ease.get(1)).wait(12).to({rotation:-2160},22,cjs.Ease.get(1)).wait(97).to({rotation:-2520},16,cjs.Ease.get(-1)).to({rotation:-3240,x:-629.5},28,cjs.Ease.get(-1)).to({_off:true},1).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(180).to({_off:false},0).wait(16).to({x:-863.8},28,cjs.Ease.get(-1)).to({_off:true},1).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(180).to({x:495.2},20,cjs.Ease.get(-1)).to({x:1080.1},28,cjs.Ease.get(1)).wait(17).to({y:199.8},0).to({y:603.7},11).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1835.4,-70.4,2362.4,1274.7);
...
(lib.blizzardANIM = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-155.6,-105.6,1,1,0,0,180,142.8,114.8);
	...
	this.instance_2.setTransform(-27.2,-73.6,1,1,0,0,0,142.8,114.8);
...
p.nominalBounds = new cjs.Rectangle(-297.3,-241.9,411.9,309.4);
...
(lib.FS_SnowIce_160x600_V6AWP = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(77.8,555.6,1,1,0,0,0,170,26);
	...
	this.timeline.addTween(cjs.Tween.get(this.hero).to({_off:true},1).wait(131).to({_off:false,scaleX:0.85,scaleY:0.85,x:222.1,y:402.9},0).to({x:122.1,y:451.9},17,cjs.Ease.get(1)).wait(30).to({rotation:-28.7,x:162.1,y:447},18,cjs.Ease.get(1)).wait(15).to({rotation:-7.2,x:242},23,cjs.Ease.get(1)).to({_off:true},1).wait(150));

	// cta
	this.instance_1 = new lib.cta();
	this.instance_1.setTransform(80.5,433.4,1,1,0,0,0,51.1,12.2);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(355).to({_off:false},0).to({alpha:1},7).wait(24));

	// Layer 30
	this.instance_2 = new lib.txt_thebestforyourcat();
	this.instance_2.setTransform(86.5,553.5,1.1,1.1,0,0,0,92.5,45.6);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(333).to({_off:false},0).to({alpha:1},9).wait(44));

	// txt
	this.instance_3 = new lib.txt_3();
	this.instance_3.setTransform(112.1,58.1,1,1,0,0,0,124,27.8);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(323).to({_off:false},0).to({alpha:1},7).wait(56));

	// blizzard
	this.instance_4 = new lib.blizzardANIM("synched",0,false);
	this.instance_4.setTransform(-106.6,154.2,1,1,0,0,0,4,4);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(338).to({_off:false},0).to({_off:true},33).wait(15));

	// Layer 16
	this.instance_5 = new lib.txt_dontspinyourwheels();
	this.instance_5.setTransform(98.2,99.9,1,1,0,0,0,140.1,40.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(74).to({_off:false},0).to({alpha:1},7).wait(69).to({alpha:0},7).to({_off:true},1).wait(228));

	// CAMERA
	this.instance_6 = new lib.CAMERAanim("synched",0,false);
	this.instance_6.setTransform(91.1,294.1,0.7,0.7,0,0,0,181.7,95.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(100).to({mode:"single",startPosition:100},0).wait(15).to({x:91.2,y:294,startPosition:114},0).wait(82).to({mode:"synched",startPosition:119,loop:false},0).wait(15).to({startPosition:134},0).to({scaleX:0.3,scaleY:0.3,x:204.2,y:303.9,startPosition:179},27,cjs.Ease.get(1)).wait(147));

	// hero
	this.instance_7 = new lib.hero();
	this.instance_7.setTransform(36.1,-180,1,1,0,0,0,300,500);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(304).to({_off:false},0).to({y:220},16,cjs.Ease.get(-1)).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(304).to({_off:false},0).to({regX:491.3,scaleX:0.18,scaleY:0.76,x:77.1,y:300,alpha:0.102},16).wait(66));

	// drift
	this.instance_9 = new lib.snowdriftALL();
	this.instance_9.setTransform(204.6,185,1.061,1.061,0,0,0,360.1,81.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(212).to({regX:360.2,regY:81.9,scaleX:0.78,scaleY:0.78,x:165.5,y:226.6},27,cjs.Ease.get(1)).to({x:285.5},33,cjs.Ease.get(-1)).to({x:365.5},17,cjs.Ease.get(1)).wait(15).to({regY:81.8,scaleX:1,scaleY:1,x:404.5,y:227.6},16,cjs.Ease.get(1)).wait(66));

	// bg
	this.instance_10 = new lib.bg();
	this.instance_10.setTransform(78.3,299.1,0.172,0.749,0,0,0,491.4,406.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(386));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1240.8,294.4,1907.8,1075.7);
